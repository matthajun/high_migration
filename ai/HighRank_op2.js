...
module.exports.searchAndtransm = async function() {
    schedule.scheduleJob('55 * * * * *', async function() {
        ...
        //     table_name = \'motie_ai_op_result\'`;  //인서트된 버전의 최대값
        ...
        // isTest = true;
        //
        // let a_time = setDateTime.setDateTime_1121(200, 1);   //데이터전송테스트
        // let b_time = setDateTime.setDateTime_1121_plus(200);  //데이터전송테스트
        //
        // const query = `select * from dti.motie_ai_op_result where version >= '${a_time}' and version < '${b_time}' `;  //데이터전송테스트
        ...
        try {
            ...
            if (rslt instanceof Error) {
                ...
                if (!isTest) //테스트가 아닐 경우에만, 실코드의 경우에만 version 오브젝트에 버전 값 전달
